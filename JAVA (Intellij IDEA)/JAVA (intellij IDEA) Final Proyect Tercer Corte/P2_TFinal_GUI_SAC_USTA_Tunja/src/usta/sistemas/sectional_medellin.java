...
class form_sectional_medellin extends JFrame {
    public form_sectional_medellin() {
        setLayout(new BorderLayout());
        //panel superior
        JPanel panel_superior = new JPanel();
        JLabel label_menu = new JLabel("Sectional USTA Medellin", SwingConstants.CENTER);
        ...
        JLabel label_maker5 = new JLabel("<html>La Universidad Santo Tomás, Primer Claustro Universitario de Colombia,<br/>" +
        ...
        label_maker5.setFont(new Font("Cooper Black", 0, 20));
        label_maker5.setBackground(Color.orange);
        panel_central.setBackground(Color.orange);
        panel_central.add(label_maker5);
